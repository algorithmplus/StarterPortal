...
BEGIN TRY
    ...
    IF (@serviceId IS NOT NULL)
        ...
        IF (@policyId IS NOT NULL)
            ...
            SET @policyConditionId = (SELECT id FROM PolicyCondition WHERE PolicyId = @policyId AND Field = 'organisation.id' AND VALUE = '4792e565-6abd-4b21-b372-ee2f651804cf');
            ...
            SET @policyId_1 = NEWID();
                ...
                --Create Policy Conditions - Organisations
                INSERT INTO PolicyCondition (Id, PolicyId, Field, Operator, Value, CreatedAt, UpdatedAt)
                VALUES  (NEWID(), @policyId_1, 'organisation.id', 'is', '4792e565-6abd-4b21-b372-ee2f651804cf', GETDATE(), GETDATE());
