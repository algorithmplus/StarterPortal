...
BEGIN TRY
    ...
    IF (@serviceId IS NOT NULL)
        ...
        IF (@policyId IS NOT NULL)
            ...
            SET @policyConditionId = (SELECT id FROM PolicyCondition WHERE PolicyId = @policyId AND Field = 'organisation.id' AND VALUE = 'eac4992c-2011-4c22-a8c0-032608adb43c');
            ...
            SET @policyId_1 = NEWID();
                ...
                --Create Policy Conditions - Organisations
                INSERT INTO PolicyCondition (Id, PolicyId, Field, Operator, Value, CreatedAt, UpdatedAt)
                VALUES  (NEWID(), @policyId_1, 'organisation.id', 'is', 'eac4992c-2011-4c22-a8c0-032608adb43c', GETDATE(), GETDATE());
