        ...
        IF (@serviceId IS NOT NULL)
            ...
            IF (@roleId_1 IS NOT NULL)
                ...
                BEGIN
                    ...
                    VALUES  (NEWID(), 1, '99b2abf2-57fb-4e24-8f65-a5563907351f', @orgId, @serviceId, GETDATE(), GETDATE());

                    INSERT INTO user_service_roles (id, user_id, service_id, organisation_id, role_id, createdAt, updatedAt)
                    VALUES  (NEWID(), '99b2abf2-57fb-4e24-8f65-a5563907351f', @serviceId, @orgId, @roleId_1, GETDATE(), GETDATE());
            ...
            IF (@roleId_2 IS NOT NULL)
                ...
                BEGIN
                    ...
                    INSERT INTO user_service_roles (id, user_id, service_id, organisation_id, role_id, createdAt, updatedAt)
                    VALUES  (NEWID(), '99b2abf2-57fb-4e24-8f65-a5563907351f', @serviceId, @orgId, @roleId_2, GETDATE(), GETDATE());
            ...
            IF (@roleId_3 IS NOT NULL)
                ...
                BEGIN
                    ...
                    INSERT INTO user_service_roles (id, user_id, service_id, organisation_id, role_id, createdAt, updatedAt)
                    VALUES  (NEWID(), '99b2abf2-57fb-4e24-8f65-a5563907351f', @serviceId, @orgId, @roleId_3, GETDATE(), GETDATE());
