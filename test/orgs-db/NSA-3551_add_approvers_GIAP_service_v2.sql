BEGIN TRAN GIAPK2SAPPROVERS
BEGIN TRY

    DECLARE @serviceId_OLD_1 UNIQUEIDENTIFIER = (SELECT id FROM service WHERE name ='Apply to convert');
    DECLARE @serviceId_OLD_2 UNIQUEIDENTIFIER = (SELECT id FROM service WHERE name ='Teacher Services - Employer Access - Schools');
    ...
    ROLLBACK TRAN GIAPK2SAPPROVERS;
