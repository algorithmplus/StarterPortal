...
BEGIN TRY
    ...
    SET @orgId = (SELECT id FROM organisation WHERE name = @orgName_1 AND Category = '008');
    ...
    SET @orgId = (SELECT id FROM organisation WHERE name = @orgName_2 AND Category = '008');
    IF (@orgId IS NOT NULL)
