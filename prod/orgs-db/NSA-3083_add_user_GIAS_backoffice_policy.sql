...
BEGIN TRY
    ...
    DECLARE @policyId_Two UNIQUEIDENTIFIER;
        ...
        SET @policyId_One = '88df18ad-7a0f-4617-ba76-13f48ae3149e';
            ...
            VALUES (NEWID(), @policyId_One, 'email', 'is', '679099df-be20-470f-bfa0-c281afba1b6a', GETDATE(), GETDATE());

        SET @policyId_Two = '46df98bb-3b86-4e0a-9ac9-e22c70243640';
              -- Create Policy Condition
            INSERT INTO PolicyCondition (Id, PolicyId, Field, Operator, Value, CreatedAt, UpdatedAt)
            VALUES (NEWID(), @policyId_Two, 'email', 'is', '679099df-be20-470f-bfa0-c281afba1b6a', GETDATE(), GETDATE());
