...
BEGIN TRY
    ...
    DECLARE @userId UNIQUEIDENTIFIER = 'f9424d2d-1dc8-4a77-9879-819197945a70';
    ...
    DECLARE @serviceName_2 VARCHAR(500) = 'OPAFastForm';
    ...
    IF (@orgId IS NOT NULL)
        ...
        IF (@serviceId_1 IS NOT NULL)
            ...
            -- Step 2b) get service Id based on name, if more than one found it will fail and go to catch block
            ...
            IF (@serviceId_2 IS NOT NULL)
                ...
                IF (@roleId_1 IS NOT NULL)
                    ...
                    BEGIN
                        ...
                        VALUES  (NEWID(), @userId, @serviceId_1, @orgId, @roleId_1, GETDATE(), GETDATE());
                ...
                IF (@roleId_2 IS NOT NULL)
                    ...
                    BEGIN
                        ...
                        INSERT INTO user_service_roles (id, user_id, service_id, organisation_id, role_id, createdAt, updatedAt)
                        VALUES  (NEWID(), @userId, @serviceId_1, @orgId, @roleId_2, GETDATE(), GETDATE());
                ...
                IF (@roleId_3 IS NOT NULL)
                    ...
                    BEGIN
                        ...
                        INSERT INTO user_service_roles (id, user_id, service_id, organisation_id, role_id, createdAt, updatedAt)
                        VALUES  (NEWID(), @userId, @serviceId_1, @orgId, @roleId_3, GETDATE(), GETDATE());
                    ...
                    IF (@roleId_4 IS NOT NULL)
                        ...
                        BEGIN
                            ...
                            INSERT INTO user_services (id, status, user_id, organisation_id, service_id, createdAt, updatedAt)
                            VALUES  (NEWID(), 1, @userId, @orgId, @serviceId_2, GETDATE(), GETDATE());

                            INSERT INTO user_service_roles (id, user_id, service_id, organisation_id, role_id, createdAt, updatedAt)
                            VALUES  (NEWID(), @userId, @serviceId_2, @orgId, @roleId_3, GETDATE(), GETDATE());
