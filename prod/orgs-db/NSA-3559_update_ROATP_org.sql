...
BEGIN TRY
    ...
    DECLARE @orgName_1 VARCHAR(500) = 'USER CRUNCH LTD.';
    DECLARE @orgName_2 VARCHAR(500) = 'EDUCATION GOALS SUCCESS (EGS) LTD';
    DECLARE @orgName_3 VARCHAR(500) = 'DV8 TRAINING LTD';
    DECLARE @orgName_4 VARCHAR(500) = 'THE BASSETLAW TRAINING AGENCY LIMITED';
    ...
    IF (@orgId IS NOT NULL)
        ...
        UPDATE organisation
            SET name = 'EDUCATION GOALS LTD', updatedAt=GETDATE()
            WHERE id = @orgId AND UKPRN = '10083696';
