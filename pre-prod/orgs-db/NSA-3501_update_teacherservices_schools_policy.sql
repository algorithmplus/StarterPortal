...
BEGIN TRY
    ...
    IF (@serviceId IS NOT NULL)
        ...
        IF (@policyId IS NOT NULL)
            ...
            SET @policyConditionId = (SELECT id FROM PolicyCondition WHERE PolicyId = @policyId AND Field = 'organisation.id' AND VALUE = 'd179305b-72e8-42ce-bc95-18a1aa558bf6');
            ...
            SET @policyId_1 = NEWID();
                ...
                --Create Policy Conditions - Organisations
                INSERT INTO PolicyCondition (Id, PolicyId, Field, Operator, Value, CreatedAt, UpdatedAt)
                VALUES  (NEWID(), @policyId_1, 'organisation.id', 'is', 'd179305b-72e8-42ce-bc95-18a1aa558bf6', GETDATE(), GETDATE());
