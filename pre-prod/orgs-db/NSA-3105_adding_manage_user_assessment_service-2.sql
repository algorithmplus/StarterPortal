...
DECLARE @roleId_1 UNIQUEIDENTIFIER = '7bdb700d-cb1d-4df1-9750-1188a05a47df';
DECLARE @roleId_2 UNIQUEIDENTIFIER = 'd091424d-a863-4316-8421-697708d56de4';
    ...
    VALUES (NEWID(), @userId, @serviceId, @orgId, @roleId_1, GETDATE(), GETDATE()),
           (NEWID(), @userId, @serviceId, @orgId, @roleId_2, GETDATE(), GETDATE());
